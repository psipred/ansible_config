...
pkgdatadir = $(datadir)/EMBOSS
pkgincludedir = $(includedir)/EMBOSS
pkglibdir = $(libdir)/EMBOSS
pkglibexecdir = $(libexecdir)/EMBOSS
...
am__aclocal_m4_deps = $(top_srcdir)/m4/amd64.m4 \
	$(top_srcdir)/m4/axis2c.m4 $(top_srcdir)/m4/general.m4 \
	$(top_srcdir)/m4/hpdf.m4 $(top_srcdir)/m4/idxdbs.m4 \
	$(top_srcdir)/m4/java.m4 $(top_srcdir)/m4/lf_x11.m4 \
	$(top_srcdir)/m4/libtool.m4 $(top_srcdir)/m4/ltoptions.m4 \
	$(top_srcdir)/m4/ltsugar.m4 $(top_srcdir)/m4/ltversion.m4 \
	$(top_srcdir)/m4/lt~obsolete.m4 $(top_srcdir)/m4/mysql.m4 \
	$(top_srcdir)/m4/pkg.m4 $(top_srcdir)/m4/pngdriver.m4 \
...
CONFIG_HEADER = $(top_builddir)/ajax/core/config.h
CONFIG_CLEAN_FILES =
...
ACLOCAL = ${SHELL} /opt/EMBOSS-6.4.0/missing --run aclocal-1.11
AJAX_FIXED_ROOT = \"/opt/EMBOSS-6.4.0/emboss\"
AJAX_SYSTEM = \"Linux\"
AMTAR = ${SHELL} /opt/EMBOSS-6.4.0/missing --run tar
AR = ar
AUTOCONF = ${SHELL} /opt/EMBOSS-6.4.0/missing --run autoconf
AUTOHEADER = ${SHELL} /opt/EMBOSS-6.4.0/missing --run autoheader
AUTOMAKE = ${SHELL} /opt/EMBOSS-6.4.0/missing --run automake-1.11
AWK = gawk
AXIS2C_CFLAGS = 
AXIS2C_CPPFLAGS = 
AXIS2C_LDFLAGS = 
...
CFLAGS =   -O2  -DNO_AUTH -D__amd64__
CPP = gcc -E
CPPFLAGS = -DAJ_LinuxLF -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -D_LARGEFILE64_SOURCE 
CXX = g++
CXXCPP = g++ -E
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /opt/EMBOSS-6.4.0/missing --run makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
MYSQL_CFLAGS = -I/usr/include/mysql
MYSQL_CONFIG = /bin/mysql_config
MYSQL_CPPFLAGS = -I/usr/include/mysql
MYSQL_LDFLAGS = -L/usr/lib64/mysql -lmysqlclient -lpthread -lz -lm -lssl -lcrypto -ldl
...
PACKAGE_NAME = EMBOSS
PACKAGE_STRING = EMBOSS 6.4.0
PACKAGE_TARNAME = EMBOSS
...
POSTGRESQL_LDFLAGS = -L/usr/lib64 -lpq
...
X_LIBS = 
X_PRE_LIBS =  -lSM -lICE
abs_builddir = /opt/EMBOSS-6.4.0
abs_srcdir = /opt/EMBOSS-6.4.0
abs_top_builddir = /opt/EMBOSS-6.4.0
abs_top_srcdir = /opt/EMBOSS-6.4.0
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /opt/EMBOSS-6.4.0/install-sh
javac_in_path = true
...
SUBDIRS = plplot ajax nucleus emboss test doc
